...
//STRING PARA BANCO
char INSERIR_AGUA[] = "INSERT INTO agua (id_casa, quant_consumo) VALUES (%s, %s)";
char INSERIR_LUZ[] = "INSERT INTO energia (id_casa, quant_consumo) VALUES (%s, %s)";
char STATUS_BOTAOAGUA[] = "SELECT (status_agua) FROM casa WHERE id_casa = Casa";
char STATUS_BOTAOLUZ[] = "SELECT (status_energia) FROM casa WHERE id_casa = Casa";
...
//~~variaveis leitura botao fisico agua
//FAZER
//~~variaveis leitura botao fisico luz
//FAZER
//~~variaveis leitura sensor presença
//FAZER
...
void leituraAgua(){
   ...
   leituraconvertida = (float(analogRead(SenAgua))*5/(1023))/0.1; //converte os valores de sensor para valores reais
...
void leituraLuz(){
   ...
   leituraconvertida = (float(analogRead(SenLuz))*5/(1023))/0.1; //converte os valores de sensor para valores reais
...
void enviaDados(){	
    ...
    delay(60000); //delay de um minuto
}
